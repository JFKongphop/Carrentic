...
import { CIO_PERSONA } from "./personas/cio";
...
export type AgentKind = "cfo" | "ingest" | "cio";
...
export const AGENTS: Record<AgentKind, AgentSpec> = {
  ...
  cio: {
    // Reuses the cfo skill (ledger know-how); the persona reframes it for the fund.
    skillsDir: "cfo",
    memoryNamespace: "cio",
    buildSystemPrompt: withContext(CIO_PERSONA),
    tools: [
      getFund,
      payCouponTool,
      onboardInvestorTool,
